  ...
  const experience = [
    {
      ...
      years: "2025 – Present",
      achievements: [
        "Co-founded Syphon Labs, leading product strategy, vision, and go-to-market execution to build and launch AI-powered tools from the ground up.",
        "Drove cross-functional alignment across engineering, design, and business stakeholders to define roadmap priorities, establish product-market fit, and accelerate early growth.",
      ],
    },
    {
      role: "Coordinating Manager, Automation Systems",
      company: "NYC Health + Hospitals",
      companyUrl: "https://www.nychealthandhospitals.org/",
      years: "Sep 2024 – Jan 2026",
      achievements: [
        "Led end-to-end design and deployment of intelligent workflow automation systems, replacing manual triage with rule-based decision engines that improved operational efficiency by ~30% across high-volume tasks.",
        "Directed cross-functional teams to define system architecture, build SQL/Python automation pipelines, and implement Tableau monitoring frameworks — driving continuous optimization of throughput, latency, and compliance.",
      ],
    },
    {
      ...
      achievements: [
        "Spearheaded evaluation of AI-driven product opportunities by leading financial modeling and system-level cost–performance analysis, directly informing leadership's roadmap decisions.",
        "Defined success metrics, guardrails, and evaluation criteria for AI-assisted initiatives, aligning cross-functional stakeholders on model behavior, business objectives, and user trust requirements.",
      ],
    },
    {
      ...
      years: "Sep 2024 – Dec 2024",
      achievements: [
        "Owned end-to-end delivery of a real-time data product for academic decision-making, leading stakeholder alignment, requirements definition, and pipeline architecture from inception to launch.",
        "Drove adoption of automated data quality and anomaly detection frameworks, establishing monitoring standards that ensured system reliability and early detection of pipeline failures.",
      ],
    },
    {
      ...
      achievements: [
        "Led conversion of 100+ CSV datasets into executive-facing KPI dashboards in Looker Studio and Tableau, directly supporting institutional decision-making and accreditation reporting.",
        "Collaborated with cross-functional stakeholders to define MVP requirements, ensuring analytical deliverables aligned with project goals across research and administrative teams.",
      ],
    },
    {
