export type Project = {
  id: string
  /** Featured entries get the large "Now" treatment on the homepage index;
      unlisted ones (e.g. tableau-portfolio) keep their page but stay out of the index. */
  tier?: "featured" | "listed" | "unlisted"
  /** Short marker shown beside the title in the index, e.g. "Springer, published". */
  mark?: string
  /** Short title used on cards, the detail page heading, and page metadata. */
  title: string
  /** One-line summary used on cards and as the page meta description. */
  description: string
  /** Long-form HTML body rendered on the detail page. */
  fullDescription: string
  image: string
  gallery: string[]
  video?: string
  demoVideo?: string
  /** Poster frame for demoVideo; required whenever demoVideo is set so the
      player never renders as a blank box (reduced-motion, pre-scroll). */
  ...
  competitionUrlText?: string
  timeline: string
  client: string
  role: string
  outcomes: string[]
  tools: string[]
  productManagementSkills?: string[]
...
export const projects: Project[] = [
  {
    ...
    title: "Syphon Labs",
    description:
      "I co-founded Syphon Labs to replace fragmented tools with context-aware AI systems. Our flagship, Talenry, is an AI career agent used by thousands of professionals; Daisy Recruiter brings the same engine to hiring teams.",
    fullDescription: `
      <p>I co-founded Syphon Labs on a simple observation: most AI tools generate outputs but leave the workflow around them broken. We build the opposite kind of product, context-aware systems that combine generation, evaluation, and workflow management into one stateful whole, for individuals and for enterprises. We started with recruitment; payroll and broader enterprise functions are next.</p>

      <p>Our flagship is Talenry, the AI career agent that grew out of our first product, Draft Resumes. A job search is not a document you write once; it is a workflow you run dozens of times. Talenry runs that workflow end to end: it tailors ATS-optimized resumes and cover letters to each posting, ranks openings by real fit, autofills and submits applications with human approval on every send, finds the hiring contact and follows up, rehearses you in real-time voice interviews, and tracks everything in one dashboard. It ships as a web portal, a browser extension, and iOS and Android apps, and thousands of professionals use it today.</p>

      <p>On the hiring side, Daisy Recruiter, currently in closed pilot with select teams, takes a single instruction like &ldquo;find me a senior backend engineer&rdquo; and sources, screens, scores, and schedules autonomously, backed by explainable scorecards and native ATS integrations. Both agents run on the same context engine, and Recruiter Alpha will expose that engine, our candidate data, semantic search, and fit scoring, as an API for enterprise teams that would rather build than buy.</p>

      <p>Under the surface, multi-step LangGraph pipelines handle parsing, generation, evaluation, and refinement while holding context across iterations, so the tenth application benefits from the first nine. The engineering work is keeping that stateful machinery consistent and fast enough for real-time use.</p>

      <p>I lead product, vision, and go-to-market: what we build, why it wins, and how it reaches customers.</p>
    `,
    image: "/images/draft/syphon-labs-logo.png",
    gallery: [
      "/images/draft/draft-page-1.jpg",
      "/images/draft/ats-page.png",
      "/images/draft/dashboard.png",
      "/images/draft/extension.png",
    ],
    video: "/images/draft/draft-demo-video.mp4",
    tags: [
      "AI Product Strategy",
      "Startup Founding",
      "Agentic Systems",
    ...
    role: "Co-Founder & CEO",
    outcomes: [
      "Talenry is live as the flagship AI career agent, used by thousands of professionals across web, browser extension, and iOS/Android",
      "Grew the product from Draft Resumes (tailored resumes, cover letters, ATS scoring) into a full agent: auto-apply with human approval, recruiter outreach, voice interview practice, and application analytics",
      "Daisy Recruiter, our agentic hiring platform, is in closed pilot with select teams, with native Greenhouse, Lever, and LinkedIn integrations",
      "Recruiter Alpha, an API over our candidate data, semantic search, and fit scoring, is opening to select enterprise partners",
    ],
    tools: [
      "LangGraph",
    ...
    productManagementSkills: [
      "Startup co-founding and product vision",
      "AI system architecture and orchestration",
      "Go-to-market strategy",
      "Cross-functional team leadership",
      "Roadmap definition and prioritization",
      "Stakeholder alignment and user research",
    ],
  },
  {
    id: "tableau-portfolio",
    tier: "unlisted",
    title: "Tableau Dashboard Portfolio",
    description:
    ...
    gallery: ["/images/tableau-portfolio-gallery-1.jpg", "/images/tableau-portfolio-gallery-2.jpg"],
    tags: [
      "Data Visualization",
      "Business Analytics",
      "KPI Tracking",
  ...
  },
  {
    id: "treevah",
    tier: "listed",
    title: "Treevah: Growth Strategy & Financial Model",
    description:
    ...
    gallery: ["/images/treevah-gallery-1.jpg", "/images/treevah-gallery-2.jpg"],
    tags: [
      "Business Analytics",
      "Financial Modeling",
  ...
  },
  {
    ...
    tier: "listed",
    title: "NYC Health + Hospitals: Analytics Modernization",
    description:
    ...
    gallery: ["/images/nyc-health-harlem-gallery.jpg"],
    tags: [
  ...
  },
  {
    ...
    tier: "listed",
    mark: "Springer, published",
    title: "Wearable Tachycardia Monitor",
    description:
  ...
  },
  {
    ...
    tier: "listed",
    mark: "Springer, published",
    title: "Self-Balancing Assistive Bicycle",
    description:
    ...
    demoVideo: "/images/self-balancing-bicycle-demo.mp4",
    demoVideoPoster: "/images/self-balancing-bicycle-demo-poster.jpg",
    tags: [
      "Embedded Systems",
      "Autonomous Mobility",
      "IoT Architecture",
  ...
  },
  {
    ...
    tier: "listed",
    mark: "IEEE, published",
    title: "IoT Personal Safety Device",
    description:
    ...
    fullDescription: `
      <p>As Project Lead, I directed a team in the design and development of a compact, IoT-enabled personal safety device featuring real-time GPS tracking and SOS broadcasting. Our goal was to enhance personal security for vulnerable groupsâincluding women, children, pets, and Alzheimer’s patientsâby providing instant location sharing and emergency alerts.</p>
  ...
  },
  {
    id: "edhitha-uas",
    tier: "listed",
    mark: "Top 10, AUVSI SUAS 2018",
    title: "Edhitha Autonomous Aerial Systems",
    description:
    ...
    demoVideo: "/images/edhitha-uas-demo.mp4",
    demoVideoPoster: "/images/edhitha-uas-demo-poster.jpg",
    ...
    githubUrl:
      "https://www.newindianexpress.com/cities/bengaluru/2018/Jun/25/city-lads-impress-with-electric-unmanned-plane-1833236.html",
...
/** "Sep 2024 – Feb 2025" -> "2024–25", "2025 – Present" -> "2025–present" */
export function compactYears(timeline: string): string {
  const years = timeline.match(/\d{4}/g)
  if (!years) return timeline
  const start = years[0]
  if (/present/i.test(timeline)) return `${start}–present`
