...
const projectsData = [
  {
    id: "syphon-labs",
    title: "Syphon Labs – AI Systems Startup",
    description:
      "Co-founded Syphon Labs, an AI-native infrastructure company focused on replacing fragmented enterprise tools with context-aware, integrated workflow systems.",
    fullDescription: `
      <p>Co-founded Syphon Labs, an AI systems company focused on building AI-native infrastructure for productivity. The company starts with recruitment workflows and is expanding into broader enterprise functions such as payroll, with the goal of replacing fragmented tools with context-aware, integrated systems.</p>

      <p>Syphon Labs is built on the premise that most AI tools generate outputs but fail to structure the workflows around them. Instead of solving isolated tasks, the company focuses on designing systems that combine generation, evaluation, and workflow management into cohesive, stateful products.</p>

      <p>Its first product, Draft, applies this approach to job applications. Rather than treating resumes as static documents, Draft structures the entire workflow from content generation to evaluation and tracking, enabling users to iterate efficiently across multiple applications.</p>

      <p><strong>Draft – AI-Powered Recruitment Workflow System:</strong><br />
      Designed and developed a platform that generates tailored resumes and cover letters from job descriptions, evaluates alignment using ATS-style scoring, and enables real-time iteration through a chat-based interface. The system also includes a centralized dashboard for tracking applications and a browser extension to capture job listings directly from job boards.</p>

      <p><strong>AI System Architecture and Orchestration:</strong><br />
      Engineered multi-step, stateful AI workflows using frameworks such as LangGraph. These pipelines handle job parsing, document generation, evaluation, and refinement, maintaining context across iterations so improvements compound over time rather than resetting with each task.</p>

      <p><strong>Engineering and Performance:</strong><br />
      Focused on balancing output quality with system responsiveness. Implemented state management and intermediate evaluation layers to ensure consistency across multi-step workflows while maintaining low latency for real-time interaction.</p>

      <p><strong>User Interface and Workflow Design:</strong><br />
      Developed interactive interfaces centered around iteration and control, including chat-based editing and dashboard views. The UI is designed to expose complex AI workflows in an intuitive way, allowing users to refine outputs, track progress, and manage multiple applications seamlessly.</p>
    `,
    image: "/images/Draft%20Images/Syphon%20Labs%20Logo.png",
    gallery: [
      "/images/Draft%20Images/Draft%20Demo%20image.png",
      "/images/Draft%20Images/draft%20page%201.jpg",
      "/images/Draft%20Images/ats%20page.png",
      "/images/Draft%20Images/dashboard%20image%20.png",
      "/images/Draft%20Images/extension%202.png",
    ],
    video: "/images/Draft%20Images/Draft%20Demo%20Video.mp4",
    tags: [
      "AI Product Strategy",
      "Startup Founding",
      "Workflow Automation",
    ...
    role: "Co-Founder",
    outcomes: [
      "Co-founded and built an AI-native product focused on recruitment workflows",
      "Demonstrated expertise in designing stateful, multi-step AI systems",
      "Reduced manual effort and improved consistency in job application processes",
      "Established the foundation for expanding into payroll and broader productivity infrastructure",
    ],
    tools: [
      "LangGraph",
    ...
    <div className="min-h-screen">
      <div className="bg-muted/50 dark:bg-accent/30 py-6 md:py-8">
        <div className="container px-4 sm:px-6">
          ...
          <div className="mb-4">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold dark:gradient-text">{project.title}</h1>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 mt-6 mb-6 md:mb-8">
